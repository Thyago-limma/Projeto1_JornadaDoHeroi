...
console.clear
console.log('Um Guerreiro que Havia Morrido em Batalha, Chamado Link, Precisaria Voltar do Inferno Para Concluir Sua Vingança Contra Aquele que o Matou. Mas Para Isso, Ele Precisa Realizar a Missão de Coletar 5 Jóias que São os Amuletos Para Ele Poder Sair do Inferno');
...
do {
  ...
  if (respostas === 5) {
    console.log('Link Concluiu Seu Objetivo,Completando Assim sua Vingança e Sabendo que o Seu Carrasco Agora Sofreria Tudo o que Ele Sofreu');
      ...
      console.log('Mesmo Lutando e Usando Todas as Suas Artimanhas Link Conseguiu Sair do Inferno,Mas Não Conseguiu Concluir Sua Vingança. Sendo Assim Condenado a Vagar Pela Terra Como um Espirito Vingativo.');
  }else if (respostas === 2 || respostas ===1) {
      console.log('Link fez de Tudo pra Sair e Concluir Sua Vingança,Mas Lutando Contra Todos os Obstáculos Você Percebeu que Não Valia a Pena se Vingar e Assim Buscou Redenção. Continua Morto,Mas Agora em Um Lugar Melhor');
  }else if (respostas === 0) {
      console.log('Link Não Estava Preparado para Lutar e Conseguir as Jóias que lhe Tirassem de Onde Ele Estava. Assim, Tendo Que Viver num Mundo de Torturas Físicas e PSicologica, Por Toda Eternidade.')
  }
